      ...
      .then((res: any) => {
        ...
        for (let record in data) {
          this.dataMantenimiento.push({
            ...
            request_type: data[record].request_type == false ? "" : data[record].request_type,
            city_id: data[record].city_id == false ? [] : data[record].city_id,
            request_source: data[record].request_source == false ? "" : data[record].request_source,
            branch_office_id: data[record].branch_office_id == false ? [] : data[record].branch_office_id,
            partner_id: data[record].partner_id == false ? [] : data[record].partner_id,
            ...
            date_start: data[record].date_start == false ? "" : data[record].date_start,
            date_finish: data[record].date_finish == false ? "" : data[record].date_finish,
            description: data[record].description == false ? "" : data[record].description
          });
        }
      });
