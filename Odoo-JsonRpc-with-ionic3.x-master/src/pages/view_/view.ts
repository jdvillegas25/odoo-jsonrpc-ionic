...
import { GoogleMaps, GoogleMap, GoogleMapsEvent, LatLng, CameraPosition, MarkerOptions, Marker, MyLocation, GoogleMapsMapTypeId } from '@ionic-native/google-maps';
declare var google;
